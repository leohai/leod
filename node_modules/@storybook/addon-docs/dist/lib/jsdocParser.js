        ...
        case 'argument':
          {
            ...
            if (!(0, _lodash.isNil)(paramTag)) {
              if ((0, _lodash.isNil)(extractedTags.params)) {
...
function extractParam(tag) {
  ...
  if (!(0, _lodash.isNil)(paramName) && paramName !== 'null-null') {
    return {
      name: tag.name,
      type: tag.type,
      ...
      getTypeName: function getTypeName() {
        return !(0, _lodash.isNil)(tag.type) ? extractTypeName(tag.type) : null;
      }
    };
  }
...
function extractTypeName(type) {
  ...
  if (type.type === 'TypeApplication') {
    if (!(0, _lodash.isNil)(type.expression)) {
