...
var AnchorMdx = function AnchorMdx(props) {
  ...
  if (href) {
    ...
    if (href.startsWith('#')) {
      return _react["default"].createElement(AnchorInPage, {
        hash: href
      }, children);
...
var OcticonHeaders = SUPPORTED_MDX_HEADERS.reduce(function (acc, headerType) {
  return Object.assign({}, acc, _defineProperty({}, headerType, (0, _theming.styled)(_html.components[headerType])({
    '& svg': {
      visibility: 'hidden'
    },
    '&:hover svg': {
...
var HeaderWithOcticonAnchor = function HeaderWithOcticonAnchor(_ref3) {
  ...
  var hash = "#".concat(id);
  return _react["default"].createElement(OcticonHeader, _extends({
    id: id
  }, rest), _react["default"].createElement(OcticonAnchor, {
    "aria-hidden": "true",
    href: hash,
    tabIndex: -1,
    target: "_self",
...
var HeaderMdx = function HeaderMdx(props) {
  ...
  if (id) {
    return _react["default"].createElement(HeaderWithOcticonAnchor, _extends({
      as: as,
      id: id
    }, rest), children);
  } // @ts-ignore
...
var HeadersMdx = SUPPORTED_MDX_HEADERS.reduce(function (acc, headerType) {
  return Object.assign({}, acc, _defineProperty({}, headerType, function (props) {
    return _react["default"].createElement(HeaderMdx, _extends({
      as: headerType
    }, props));
  }));
}, {});
