...
function createTypeDef(_ref) {
  ...
  return {
    ...
    "short": _short,
    compact: compact,
    full: !(0, _lodash.isNil)(full) ? full : _short,
    ...
    case _inspection.InspectionType.ELEMENT:
      {
        ...
        _short2 = !(0, _lodash.isNil)(identifier) && !(0, _lib2.isHtmlTag)(identifier) ? identifier : _lib2.ELEMENT_CAPTION;
...
function generateFunc(extractedProp) {
  ...
  if (!(0, _lodash.isNil)(jsDocTags)) {
    if (!(0, _lodash.isNil)(jsDocTags.params) || !(0, _lodash.isNil)(jsDocTags.returns)) {
      return createTypeDef({
...
function generateObjectOf(type, extractedProp) {
  ...
  return createTypeDef({
    ...
    compact: !(0, _lodash.isNil)(compact) ? objectOf(compact) : null,
    full: objectOf(full)
  });
}
...
function createArrayOfObjectTypeDef(_short6, compact, full) {
  return createTypeDef({
    ...
    compact: !(0, _lodash.isNil)(compact) ? braceAround(compact) : null,
