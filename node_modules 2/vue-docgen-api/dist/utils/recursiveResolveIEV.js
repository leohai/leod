                                ...
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        ...
                                        case 1:
                                            ...
                                            if (!validExtends(fullFilePath_1)) {
                                                return [2 /*return*/];
                                            }
                                        ...
                                        case 2:
                                            source_1 = _b.sent();
                                            astRemote = cacher_1.default(function () { return recast_1.default.parse(source_1, { parser: babel_parser_1.default() }); }, source_1);
                                            ...
                                            if (Object.keys(returnedVariables_1).length) {
                                                exportToLocal.forEach(function (exported, local) {
                                                    if (exported && local) {
                                                        ...
                                                        if (aliasedVariable) {
                                                            aliasedVariable.filePath = aliasedVariable.filePath.map(function (p) {
                                                                return pathResolver(p, path.dirname(fullFilePath_1));
                                                            });
