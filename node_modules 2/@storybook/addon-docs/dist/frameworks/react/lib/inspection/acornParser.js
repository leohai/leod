...
function extractIdentifierName(identifierNode) {
  return !(0, _lodash.isNil)(identifierNode) ? identifierNode.name : null;
}
...
function parseFunction(funcNode) {
  ...
  acornWalk.simple(funcNode.body, {
    JSXElement: function JSXElement(node) {
      innerJsxElementNode = node;
    }
  }, ACORN_WALK_VISITORS);
  var isJsx = !(0, _lodash.isNil)(innerJsxElementNode);
  var inferedType = {
  ...
  if (!(0, _lodash.isNil)(identifierName)) {
...
function parseClass(classNode) {
  ...
  acornWalk.simple(classNode.body, {
    JSXElement: function JSXElement(node) {
      innerJsxElementNode = node;
    }
  }, ACORN_WALK_VISITORS);
  var inferedType = {
    type: !(0, _lodash.isNil)(innerJsxElementNode) ? _types.InspectionType.ELEMENT : _types.InspectionType.CLASS,
      ...
      case 'ExpressionStatement':
        {
          ...
          if (!(0, _lodash.isNil)(expressionResult)) {
