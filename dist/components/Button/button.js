...
export var Button = function (props) {
    var _a;
    var size = props.size, btnType = props.btnType, disabled = props.disabled, children = props.children, className = props.className, href = props.href, restProps = __rest(props, ["size", "btnType", "disabled", "children", "className", "href"]);
